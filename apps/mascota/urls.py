...
from apps.mascota.views import listadousuarios, index_mascota, mascota_view, mascota_list, mascota_edit, mascota_delete, MascotaList, MascotaCreate, MascotaUpdate, MascotDelete
...
urlpatterns = [
    ...
    url(r'^eliminar/(?P<pk>\d+)/$',
        login_required(MascotDelete.as_view()), name="mascota_eliminar"),
